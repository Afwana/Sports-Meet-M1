...
export default async function AdminDashboard() {
  ...
  return (
    <div className="min-h-[calc(100vh-66px)] bg-linear-to-b from-blue-100/55 via-blue-100/80 to-blue-100/90 p-6 dark:bg-black">
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Admin Dashboard</h1>

          <p className="mt-1 text-sm text-default-500">
            Manage Recreation Meet 2026 settings and data.
          </p>
        </div>
