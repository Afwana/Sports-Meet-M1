  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col md:hidden">
        ...
        {/* Main Content */}
        <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-5 pb-85 pt-10 text-center text-white">
          <h1 className="text-3xl font-bold">Sports Meet 2026</h1>
        ...
        >
          ...
          {expanded && (
            <Card.Content className="max-h-[60vh] overflow-y-auto p-0">
              <Announcements expanded={expanded} />
            </Card.Content>
          )}
